...
export default function GuideDetail({ slug }: { slug: string }) {
  ...
  return <div className="min-h-screen bg-background text-white">
    ...
    <Navbar/><main className="px-5 pb-24 pt-36 md:pt-44"><article className="mx-auto max-w-4xl">
      ...
      <h1 className="max-w-3xl text-balance break-words font-serif text-3xl leading-[1.12] sm:text-4xl md:text-5xl">{guide.title}</h1><p className="mt-7 text-base font-light leading-7 text-white/60 sm:text-lg sm:leading-8">{guide.excerpt}</p>
