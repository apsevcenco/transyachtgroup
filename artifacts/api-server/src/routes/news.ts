...
Internal links MUST use one of these exact paths only — never invent, guess or slightly modify a path, even one that looks plausible: /cars/, /yachts/, /services/courchevel-private-transfers/, /services/luxury-car-rental-cannes/, /services/luxury-car-rental-monaco/, /services/luxury-car-rental-nice/, /services/luxury-car-rental-saint-tropez/, /locations/cannes/, /locations/monaco/, /locations/nice/, /locations/saint-tropez/, /locations/courchevel/. If none of these fit a sentence naturally, link to a more general one from the list (e.g. /cars/) rather than inventing a new path.
